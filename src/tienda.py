...
class Clientes(threading.Thread):
    ...
    def run(self):
        ...
        self.tienda.EscribirCliente(self.nombre + " llego a la tienda")
        # va al meson
        ...
        self.tienda.EscribirCliente(self.nombre + " se fue de la tienda")
...
class Mesones(threading.Thread):
    ...
    def run(self):
        ...
        # aviso al resto de mesones para que terminen
        self.tienda.SemMesa[1].release()
        self.tienda.EscribirFuncionario(self.nombre + " termino mis funciones")
    ...
    def run(self):
        while (True):
            ...
            if(self.baño >= 5 and self.tienda.baño.Entrar()):
                self.baño = 0
                self.tienda.EscribirFuncionario(self.nombre + " fue al baño")
        # avso al resto de cajas para que terminen
